(define (problem blocks-problem)
	...
	(:goal (and (forall (?x) (done ?x)) (forall (?x) (or (not (pink ?x)) (exists (?y) (and (orange ?y) (on ?x ?y))))) (forall (?y) (or (not (orange ?y)) (exists (?x) (and (pink ?x) (on ?x ?y))))) (and (not (on b6 b7)) (on b7 b6))))
)