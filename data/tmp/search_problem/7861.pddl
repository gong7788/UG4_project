(define (problem blocks-problem)
	...
	(:goal (and (forall (?x) (done ?x)) (forall (?y) (or (not (green ?y)) (exists (?x) (and (blue ?x) (on ?x ?y))))) (forall (?x) (or (not (blue ?x)) (exists (?y) (and (green ?y) (on ?x ?y))))) (and (not (on b1 b6)) (not (on b0 b6)))))
)