(define (problem blocks-problem)
	...
	(:goal (and (forall (?x) (done ?x)) (forall (?y) (or (not (red ?y)) (exists (?x) (and (yellow ?x) (on ?x ?y))))) (forall (?x) (or (not (yellow ?x)) (exists (?y) (and (red ?y) (on ?x ?y))))) (and (not (on b0 b1)) (on b3 b8))))
)