(define (problem blocks-problem)
	...
	(:goal (and (forall (?x) (done ?x)) (forall (?x) (or (not (green ?x)) (exists (?y) (and (pink ?y) (on ?x ?y))))) (forall (?y) (or (not (pink ?y)) (exists (?x) (and (green ?x) (on ?x ?y))))) (and (not (on b9 b7)) (not (on b9 b8)))))
)