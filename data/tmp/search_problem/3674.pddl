(define (problem blocks-problem)
	...
	(:goal (and (forall (?x) (done ?x)) (forall (?y) (or (not (purple ?y)) (exists (?x) (and (green ?x) (on ?x ?y))))) (forall (?x) (or (not (green ?x)) (exists (?y) (and (purple ?y) (on ?x ?y))))) (and (not (on b0 b1)) (on b7 b4))))
)