(define (problem blocks-problem)
	...
	(:goal (and (forall (?x) (done ?x)) (forall (?x) (or (not (green ?x)) (exists (?y) (and (blue ?y) (on ?x ?y))))) (forall (?y) (or (not (blue ?y)) (exists (?x) (and (green ?x) (on ?x ?y))))) (and (not (on b2 b9)) (not (on b8 b9)))))
)