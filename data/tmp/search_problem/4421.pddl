(define (problem blocks-problem)
	...
	(:goal (and (forall (?x) (done ?x)) (forall (?y) (or (not (green ?y)) (exists (?x) (and (orange ?x) (on ?x ?y))))) (forall (?x) (or (not (orange ?x)) (exists (?y) (and (green ?y) (on ?x ?y))))) (and (not (on b4 b5)) (on b5 b4))))
)