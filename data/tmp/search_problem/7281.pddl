(define (problem blocks-problem)
	...
	(:goal (and (forall (?x) (done ?x)) (forall (?x) (or (not (red ?x)) (exists (?y) (and (green ?y) (on ?x ?y))))) (forall (?y) (or (not (green ?y)) (exists (?x) (and (red ?x) (on ?x ?y))))) (and (not (on b9 b8)) (on b7 b1))))
)