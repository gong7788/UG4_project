(define (problem blocks-problem)
	...
	(:goal (and (forall (?x) (done ?x)) (forall (?y) (or (not (blue ?y)) (exists (?x) (and (green ?x) (on ?x ?y))))) (forall (?x) (or (not (green ?x)) (exists (?y) (and (blue ?y) (on ?x ?y))))) (and (not (on b1 b2)) (not (on b5 b6)))))
)