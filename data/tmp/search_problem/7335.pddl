(define (problem blocks-problem)
	...
	(:goal (and (forall (?x) (done ?x)) (forall (?y) (or (not (green ?y)) (exists (?x) (and (purple ?x) (on ?x ?y))))) (forall (?x) (or (not (purple ?x)) (exists (?y) (and (green ?y) (on ?x ?y))))) (and (not (on b1 b2)) (on b4 b8))))
)