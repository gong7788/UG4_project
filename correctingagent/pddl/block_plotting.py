...
if __name__ == '__main__':
    height = width = 0.2
    #domain, problem = pddl_functions.parse('blocks-domain.domain', '../FF-v2.3/blocks1.domain')
    #result = ff.ff('blocks-domain.domain', '../FF-v2.3/blocks1.domain')
    ...
    domain, problem = pddl_functions.parse('blocks-domain.domain', 'blocks_problem_colour1.domain')
    objects = pddl_functions.get_objects(problem)
    state = problem.initialstate
    posns = generate_start_position(problem)
